...
HWND hwnd, pumpButton, fileSearchButton, byteButton, kiloByteButton, megaByteButton, gigaByteButton;
HMENU hFileMenu, hMenu;
ofstream file;
HBITMAP bmp, generateImage;
HWND image, cleanButton, infoButton, sizeText, path_var, fileSize;
HBRUSH hb, pincel;
HWND megabyteText, kilobyteText, gigabyteText, aboutButton, byteText;
int tipo;
...
void setImages(HWND hwnd) {
    ...
    image = CreateWindowEx(0, L"Static", NULL, WS_VISIBLE | WS_CHILD | SS_BITMAP, 250, 45, 10, 10, hwnd, (HMENU)CLEAN_BUTTON, NULL, NULL);
...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PWSTR pCmdLine, int nCmdShow) {
    ...
    RegisterClass(&wc);
    hwnd = CreateWindowEx(0, CLASS_NAME, L"BytePumper v1.2.0", WS_OVERLAPPED | WS_MINIMIZEBOX | WS_SYSMENU, CW_USEDEFAULT, CW_USEDEFAULT, 445, 230, NULL, NULL, hInstance, NULL);
